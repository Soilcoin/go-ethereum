...
var (
	...
	MainNetHomesteadGasRepriceHash = common.HexToHash("") //common.HexToHash("0x2086799aeebeae135c246c65021c82b4e15a2c451340993aacfd2751886514f0") // Mainnet gas reprice block hash (used by fast sync)
	...
	MainNetChainID = big.NewInt(42) // main net default chain ID
)
